...
namespace AWBlazorApp.Features.Person.Persons.Dtos;
...
public static class PersonMappings
{
    ...
    public static PersonEntity ToEntity(this CreatePersonRequest r) => new()
    {
        Id = r.Id,
    ...
    public static void ApplyTo(this UpdatePersonRequest r, PersonEntity e)
    {
