...
namespace AWBlazorApp.Features.Person.ContactTypes.Api;
...
public static class ContactTypeEndpoints
{
    public static IEndpointRouteBuilder MapContactTypeEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<ContactType, ContactTypeDto, CreateContactTypeRequest, UpdateContactTypeRequest, int>(
