...
namespace AWBlazorApp.Features.HumanResources.Employees.Api;
...
public static class EmployeeEndpoints
{
    public static IEndpointRouteBuilder MapEmployeeEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<Employee, EmployeeDto, CreateEmployeeRequest, UpdateEmployeeRequest, int>(
            entityName: "Employee",
