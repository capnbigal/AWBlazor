...
namespace AWBlazorApp.Features.Production.ProductCategories.Api;
...
public static class ProductCategoryEndpoints
{
    public static IEndpointRouteBuilder MapProductCategoryEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<ProductCategory, ProductCategoryDto, CreateProductCategoryRequest, UpdateProductCategoryRequest, int>(
