...
namespace AWBlazorApp.Features.Production.Locations.Api;
...
public static class LocationEndpoints
{
    public static IEndpointRouteBuilder MapLocationEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<Location, LocationDto, CreateLocationRequest, UpdateLocationRequest, short>(
            entityName: "Location",
