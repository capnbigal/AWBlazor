...
namespace AWBlazorApp.Features.Production.ProductModels.Api;
...
public static class ProductModelEndpoints
{
    public static IEndpointRouteBuilder MapProductModelEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<ProductModel, ProductModelDto, CreateProductModelRequest, UpdateProductModelRequest, int>(
