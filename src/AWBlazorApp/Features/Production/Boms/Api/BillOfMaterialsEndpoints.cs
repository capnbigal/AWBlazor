...
namespace AWBlazorApp.Features.Production.Boms.Api;
...
public static class BillOfMaterialsEndpoints
{
    public static IEndpointRouteBuilder MapBillOfMaterialsEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<BillOfMaterials, BillOfMaterialsDto, CreateBillOfMaterialsRequest, UpdateBillOfMaterialsRequest, int>(
