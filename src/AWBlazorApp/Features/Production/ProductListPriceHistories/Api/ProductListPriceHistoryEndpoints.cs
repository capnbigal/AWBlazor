...
namespace AWBlazorApp.Features.Production.ProductListPriceHistories.Api;
...
public static class ProductListPriceHistoryEndpoints
{
        ...
        ApplicationDbContext db, ClaimsPrincipal user, CancellationToken ct)
    {
        ...
        await db.AddWithAuditAsync(entity, e => ProductListPriceHistoryAuditService.RecordCreate(e, user.Identity?.Name), ct);
