...
namespace AWBlazorApp.Features.Production.ProductReviews.Api;
...
public static class ProductReviewEndpoints
{
    public static IEndpointRouteBuilder MapProductReviewEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<ProductReview, ProductReviewDto, CreateProductReviewRequest, UpdateProductReviewRequest, int>(
