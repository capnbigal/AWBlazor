...
namespace AWBlazorApp.Features.Production.TransactionHistories.Api;
...
public static class TransactionHistoryEndpoints
{
    public static IEndpointRouteBuilder MapTransactionHistoryEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<TransactionHistory, TransactionHistoryDto, CreateTransactionHistoryRequest, UpdateTransactionHistoryRequest, int>(
