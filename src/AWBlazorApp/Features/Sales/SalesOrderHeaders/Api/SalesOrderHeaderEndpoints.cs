...
namespace AWBlazorApp.Features.Sales.SalesOrderHeaders.Api;
...
public static class SalesOrderHeaderEndpoints
{
    public static IEndpointRouteBuilder MapSalesOrderHeaderEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<SalesOrderHeader, SalesOrderHeaderDto, CreateSalesOrderHeaderRequest, UpdateSalesOrderHeaderRequest, int>(
