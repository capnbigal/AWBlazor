...
namespace AWBlazorApp.Features.Sales.SpecialOfferProducts.Api;
...
public static class SpecialOfferProductEndpoints
{
        ...
        ApplicationDbContext db, ClaimsPrincipal user, CancellationToken ct)
    {
        ...
        await db.AddWithAuditAsync(entity, e => SpecialOfferProductAuditService.RecordCreate(e, user.Identity?.Name), ct);
