...
namespace AWBlazorApp.Features.Sales.SalesPeople.Api;
...
public static class SalesPersonEndpoints
{
    public static IEndpointRouteBuilder MapSalesPersonEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<SalesPerson, SalesPersonDto, CreateSalesPersonRequest, UpdateSalesPersonRequest, int>(
