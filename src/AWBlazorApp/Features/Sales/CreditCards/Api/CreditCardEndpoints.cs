...
namespace AWBlazorApp.Features.Sales.CreditCards.Api;
...
public static class CreditCardEndpoints
{
    public static IEndpointRouteBuilder MapCreditCardEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<CreditCard, CreditCardDto, CreateCreditCardRequest, UpdateCreditCardRequest, int>(
