...
namespace AWBlazorApp.Features.Sales.SalesReasons.Api;
...
public static class SalesReasonEndpoints
{
    public static IEndpointRouteBuilder MapSalesReasonEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<SalesReason, SalesReasonDto, CreateSalesReasonRequest, UpdateSalesReasonRequest, int>(
