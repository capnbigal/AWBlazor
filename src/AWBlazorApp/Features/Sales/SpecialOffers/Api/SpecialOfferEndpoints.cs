...
namespace AWBlazorApp.Features.Sales.SpecialOffers.Api;
...
public static class SpecialOfferEndpoints
{
    public static IEndpointRouteBuilder MapSpecialOfferEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapCrudWithInterceptor<SpecialOffer, SpecialOfferDto, CreateSpecialOfferRequest, UpdateSpecialOfferRequest, int>(
