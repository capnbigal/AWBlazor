...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ElementaryApp/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ElementaryApp.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ElementaryApp/Program.cs):
...
services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlite(connectionString, b => b.MigrationsAssembly(nameof(ElementaryApp))));
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/ElementaryApp/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[ElementaryApp.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/ElementaryApp/ElementaryApp.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/ElementaryApp/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/ElementaryApp/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/ElementaryApp/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/ElementaryApp/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/ElementaryApp/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/ElementaryApp/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ElementaryApp/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/ElementaryApp.ServiceInterface/EmailServices.cs) in a 
