...
- [Bookings.d.ts](https://github.com/NetCoreTemplates/react-vite/blob/main/ElementaryApp.ServiceModel/Bookings.d.ts)
...
This will generate an empty `ElementaryApp.ServiceModel/<Table>.d.ts` file along with stub AutoQuery APIs and DB Migration implementations. 
...
Along with different seed data, tailored for Income and Expenses:
 - [categoryAutoTag.ts](https://github.com/mythz/budgets.apps.cafe/blob/main/ElementaryApp.Client/src/lib/categoryAutoTag.ts)
 
And 19 passing tests to verify a working implementation:
 
 - [categoryAutoTag.test.ts](https://github.com/mythz/budgets.apps.cafe/blob/main/ElementaryApp.Client/src/lib/categoryAutoTag.test.ts)
