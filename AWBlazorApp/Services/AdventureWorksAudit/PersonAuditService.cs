...
public static class PersonAuditService
{
    ...
    public static Snapshot CaptureSnapshot(Person e) => new(e);

    public static PersonAuditLog RecordCreate(Person e, string? by)
        => BuildLog(e, ActionCreated, by, "Created");

    public static PersonAuditLog RecordUpdate(Snapshot before, Person after, string? by)
        => BuildLog(after, ActionUpdated, by, BuildDiffSummary(before, after));

    public static PersonAuditLog RecordDelete(Person e, string? by)
        => BuildLog(e, ActionDeleted, by, "Deleted");

    private static PersonAuditLog BuildLog(Person e, string action, string? by, string? summary)
        => new()
        {
            PersonId = e.Id,
            Action = action,
    ...
    private static string BuildDiffSummary(Snapshot before, Person after)
    {
