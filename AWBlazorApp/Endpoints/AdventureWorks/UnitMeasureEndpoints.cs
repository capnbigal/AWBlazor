...
public static class UnitMeasureEndpoints
{
    ...
    private static async Task<Ok<Models.PagedResult<UnitMeasureDto>>> ListAsync(
        ...
        [FromQuery] string? name = null, CancellationToken ct = default)
    {
        ...
        return TypedResults.Ok(new Models.PagedResult<UnitMeasureDto>(rows, total, skip, take));
    }
